...
html_theme_options = {
    ...
    'extra_nav_links': {
        ...
        'pynpm@PyPI': 'https://pypi.python.org/pypi/pynpm/',
    }
}
...
htmlhelp_basename = 'pynpm_namedoc'
...
latex_documents = [
  (master_doc, 'pynpm.tex', u'pynpm Documentation',
   u'CERN', 'manual'),
]
...
man_pages = [
    (master_doc, 'pynpm', u'pynpm Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'pynpm', u'PyNPM Documentation',
   author, 'pynpm', 'Python interface to your NPM and package.json.',
   'Miscellaneous'),
]
